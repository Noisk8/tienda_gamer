      ...
      /> : null}
        <div className={styles.home}>
                ...
                <video autoPlay muted loop className={styles.video}>
                  <source src={require("../../Resources/image/sNFT1.2.mp4")} type="video/mp4" />
                </video>
                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="https://github.com/noisk8" target="_blank"><button className={styles.cta} aria-label="View Repository">
